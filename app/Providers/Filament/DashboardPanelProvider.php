...
class DashboardPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        ...
        return $panel
            ...
            ->colors([
                'primary' => Color::{CompanySetting::get('primary_color')},
                'danger' => Color::{CompanySetting::get('danger_color')},
                'gray' => Color::{CompanySetting::get('gray_color')},
                'info' => Color::{CompanySetting::get('info_color')},
                'success' => Color::{CompanySetting::get('success_color')},
                'warning' => Color::{CompanySetting::get('warning_color')},
            ])
