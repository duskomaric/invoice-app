    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-1 py-6">
            <div class="w-full max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
                @if (session('success'))
                    <div class="mb-4 p-4 bg-green-50 border border-green-200 text-green-700 rounded-md flex items-center gap-2">
                ...
                @if (session('error'))
                    <div class="mb-4 p-4 bg-red-50 border border-red-200 text-red-700 rounded-md flex items-center gap-2">
