...
<div x-data="{ open: false }" class="relative" @click.away="open = false">
    ...
    <div 
        ...
        class="absolute z-[80] mt-1.5 {{ $alignClasses[$align] ?? $alignClasses['left'] }} {{ $widthClasses[$width] ?? $widthClasses['48'] }} bg-white dark:bg-slate-800 rounded-lg shadow-xl shadow-slate-900/15 dark:shadow-black/40 border border-slate-200 dark:border-slate-700 py-1 overflow-hidden"
        x-cloak
    >
        {{ $slot }}
    </div>
