...
@section('title', 'New Contract - App')
@section('page-title', 'Create Contract')
@section('page-subtitle', 'Set up a new service agreement or recurring contract')
...
@section('content')
<form id="contract-form" action="{{ route('app.contracts.store', $company) }}" method="POST"
    x-data="{
        items: [{ id: Date.now(), name: '', description: '', quantity: 1, unit_price: 0, tax_rate: 0 }],
        addItem() {
    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <x-app.card class="lg:col-span-2 relative z-20">
                ...
                <div class="mt-4" x-data="{ open: false, search: '', clients: @js($clients) }">
            ...
            <x-app.card>
                ...
                <div class="space-y-3 mt-4">
                    <x-app.input label="Start Date" type="date" name="date" value="{{ date('Y-m-d') }}" />
                    <div>
        ...
        <x-app.card class="relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                <div>
                    ...
                    <textarea name="notes" rows="4" class="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-900 border-none ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-violet-500 transition-all text-xs text-slate-600 placeholder-slate-400" placeholder="Add terms, special instructions, or other details..."></textarea>
                </div>
                <div class="space-y-2">
